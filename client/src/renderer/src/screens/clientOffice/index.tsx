...
export function ClientOffice(): JSX.Element {
  const [isOpen, setIsOpen] = useState(false)
  return (
    <Layout>
      <RenderList title="Client Offices" setIsOpen={setIsOpen}>
        <ModalCreate title="Add New Client Office" setIsOpen={setIsOpen} isOpen={isOpen}>
